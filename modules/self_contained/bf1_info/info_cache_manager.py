...
class InfoCache(object):
    ...
    async def check_if_need_api(self) -> bool:
        try:
            async with aiofiles.open(self.file_cache_path, "r", encoding="utf-8") as file:
    ...
    async def update_cache(self) -> bool:
        ...
        try:
            ...
            async with aiofiles.open(self.file_cache_path, 'w', encoding="utf-8") as file:
